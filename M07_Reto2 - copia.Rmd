...
subtitle: "Dashboard para la estrategia de ventas de una empresa"
...
## Calcular las medias por continente y año
...
## Preguntas a responder con nuestro Dashboard

### Grafico 4: ¿Cómo se compara la tasa de empleo en la industria de España con la de otros países de la Unión Europea y del mundo?
...
### Grafico 3: ¿Cómo ha evolucionado la tasa de empleo en la industria en España a lo largo del tiempo?
...
### Gráfico 5: ¿Qué países han experimentado un crecimiento significativo en su tasa de empleo en el sector industrial?
...
## Relación con el Indice de Desarrollo Sostenible
### Añadimos nuevo dataset
...
### Gráfico 6: Gráfico de dispersión por continentes
...
## Cálculo de percentiles para escoger un primer listado de países potenciales.
...
## Otros aspectos a analizar para determinar la decisión:
...
## Decisión de la estrategia de ventas:
